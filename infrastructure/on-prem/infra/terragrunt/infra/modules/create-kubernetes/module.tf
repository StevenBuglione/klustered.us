module "lxd_cluster" {
  source = "../lxc"  // path to the module implementation

  nodes = [
    { name = "pluto", address = "10.10.10.5", role = "master" },
    { name = "neptune", address = "10.10.10.3", role = "worker" },
    { name = "saturn", address = "10.10.10.4", role = "worker" },
    { name = "earth", address = "10.10.10.6", role = "worker" }
  ]
